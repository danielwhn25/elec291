...
alarm_compare_logic:
    mov a, hours
    cjne a, alarm_hours, alarm_beep_stop ; Compare hours (bytes)
    
    mov a, minutes
    cjne a, alarm_minutes, alarm_beep_stop ; Compare minutes (bytes)

    ; --- Bit Logic Fix for AM/PM ---
    jb clock_AMPM_toggle, check_pm_match
    jb alarm_AMPM_toggle, alarm_beep_stop  ; Clock is AM, Alarm is PM -> No match
    sjmp start_the_beep                    ; Both are AM -> Match!
